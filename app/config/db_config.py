...
class MongoDB:
    ...
    async def connect(self, uri: str, db_name: str):
        ...
        collection_names = ['admin', 'course', 'teacher', 'event', 'student', 'attendance', 'hof', 'feedback','school','class','calendar','assignment','journal','missing_journals']
